...
public interface GuiTranslation extends TranslateInterface {
    ...
    @Default(lngs = { "en" }, values = { "Auto open downloaded containers (dlc,nzb,ejs,...)" })
    ...
    @Default(lngs = { "en" }, values = { "Support ticket" })
    String jd_gui_swing_components_AboutDialog_ticket();
    ...
    @Default(lngs = { "en", "de" }, values = { "Invalid two-factor authentication code format!\r\nExpected format: %s1", "Ungültiges Zwei-Faktor-Authentifizierungscode-Format!\r\nErwartetes Format: %s1" })
    String jd_gui_swing_components_AccountDialog_2FA_login_invalid_format(String s);

    @Default(lngs = { "en", "de" }, values = { "Invalid two-factor authentication code!", "Ungültiger Zwei-Faktor-Authentifizierungscode!" })
    String jd_gui_swing_components_AccountDialog_2FA_login_invalid();
    ...
    @Default(lngs = { "en" }, values = { "Socks4a" })
    String jd_gui_swing_dialog_ProxyDialog_socks4a();
    ...
    @Default(lngs = { "en" }, values = { "SOCKS-4a-Protocol Proxy Server " })
    String gui_column_proxytype_socks4a_tt();
    ...
    String FileSizeColumn_FileSizeColumn();
    ...
    @Default(lngs = { "en" }, values = { "You've just applied a visual sort.\r\nNOTE: This does not change download order!\r\nTo revert this, click on the highlighted column header until the highlighting disappears.\r\nTo perform a permanent sort which will change the download order, press and hold CTRL and click inside any column header." })
    ...
    @Default(lngs = { "en" }, values = { "Subtitle File" })
    String FilterRuleDialog_createTypeFilter_mime_subtitle();

    @Default(lngs = { "en" }, values = { "Executable File" })
    String FilterRuleDialog_createTypeFilter_mime_executable();
    ...
    @Default(lngs = { "en" }, values = { "Current packagename" })
    String PackagizerFilterRuleDialog_createVariablesMenu_current_packagename();
    ...
    @Default(lngs = { "en" }, values = { "Import Packagizerrules" })
    String Packagizer_import_dialog_title();
    ...
    @Default(lngs = { "en" }, values = { "Order" })
    String settings_rules_columns_exeorder();
    ...
    @Default(lngs = { "en" }, values = { "File Path" })
    String searchcategory_filepath();
    ...
    @Default(lngs = { "en" }, values = { "Please enter the file path you are looking for..." })
    String searchcategory_filepath_help();
    ...
    @Default(lngs = { "en" }, values = { "Socks 4a Proxy" })
    String gui_column_proxytype_socks4a();
    ...
    @Default(lngs = { "en" }, values = { "Show only modified values" })
    String AdvancedTableModel_initColumns_modifiedonly_checkboxaction_();
    ...
    @Default(lngs = { "en" }, values = { "Dialog 'Don't show again' have been reset!" })
    String GUISettings_actionPerformed_reset_done();

    @Default(lngs = { "en" }, values = { "Dialog 'Positions and Dimensions' have been reset!" })
    String GUISettings_actionPerformed_reset_location_done();
    ...
    @Default(lngs = { "en" }, values = { "Customize JDownloader -  Modify the User Interface, Menus, Language, ... whatever" })
    ...
    @Default(lngs = { "en" }, values = { "a Container file is loaded" })
    String plugins_optional_JDLightTray_ballon_container();
    ...
    @Default(lngs = { "en" }, values = { "Disabled, don't use any account of this group" })
    String Rules_disabled();
    ...
    @Default(lngs = { "en" }, values = { "The %s1 Plugin Settings have been reset to default values!" })
    ...
    @Default(lngs = { "en" }, values = { "MD5/SHA1/SHA256/CRC32:" })
    ...
    @Default(lngs = { "en" }, values = { "Show Checksum (MD5/SHA1/SHA256/CRC32)" })
    ...
    @Default(lngs = { "en" }, values = { "SVG:" })
    String jd_gui_swing_components_AboutDialog_svg();
    ...
    @Default(lngs = { "en" }, values = { "If link equals Playlist or Channel-List or User-List" })
    ...
    @Default(lngs = { "en" }, values = { "(if available prefer alternative one, eg. localized)" })
    String YoutubeHelper_getDescription_alternative();
    ...
    @Default(lngs = { "en" }, values = { "Don't move, move completed items only" })
    ...
    @Default(lngs = { "en" }, values = { "Number of views" })
    ...
    @Default(lngs = { "en" }, values = { "Click me / Mouse over" })
    String jd_gui_swing_components_AboutDialog_installdir_anon();
    ...
    @Default(lngs = { "en" }, values = { "Removal in Progress" })
    String InstalledExtension_getPanel_install_in_progress();

    @Default(lngs = { "en" }, values = { "Remove now" })
    String InstalledExtension_getPanel_();

    @Default(lngs = { "en" }, values = { "Please restart JDownloader to finish the removal." })
    String InstalledExtension_waiting_for_restart();
    ...
    String ExtensionController_initUninstalledExtensions_AntiShutdownExtension_description();

    @Default(lngs = { "en" }, values = { "AntiStandBy" })
    String ExtensionController_initUninstalledExtensions_AntiShutdownExtension();
    ...
    String DonationDialog_layoutDialogContent_top_text(int years);
    ...
    @Default(lngs = { "en" }, values = { "This Captcha type requires a real browser.\r\nPlease solve the Captcha Challenge in your browser." })
    ...
    @Default(lngs = { "en" }, values = { "Best Video resolution height in pixel" })
    String YoutubeHelper_getDescription_best_height();
    ...
    @Default(lngs = { "en" }, values = { "Playlist creator: Name of the user who published the playlist." })
    String YoutubeHelper_getDescription_playlist_creator();
