...
public class Offline extends PluginForHost {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "segavid.com" });
        ret.add(new String[] { "swiftload.io" });
        ...
        ret.add(new String[] { "uploadev.org", "uploadev.com" });
        ret.add(new String[] { "uploadhub.to" });
        ret.add(new String[] { "userupload.in" });
        ret.add(new String[] { "usafiles.net" });
        ret.add(new String[] { "filegram.to" });
        ret.add(new String[] { "lulacloud.com" });
        ret.add(new String[] { "videowood.tv" });
        ret.add(new String[] { "vidker.com" });
        ret.add(new String[] { "vidpirate.com" });
        ret.add(new String[] { "uploadhub.io" });
        ret.add(new String[] { "megaupto.com" });
        ret.add(new String[] { "opvid.org", "opvid.online", "opvid.co", "upvid.cloud", "upvid.biz", "upvid.co", "golvid.com" });
        ret.add(new String[] { "filedo.net" });
        ret.add(new String[] { "volafile.org", "volafile.io" });
        ret.add(new String[] { "yimuhe.com" });
        ...
        ret.add(new String[] { "uploadbox.io" });
