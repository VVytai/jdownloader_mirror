...
public class LibGenCrawler extends PluginForDecrypt {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "libgen.li", "libgen.ee", "libgen.gs", "libgen.lc", "libgen.rocks", "libgen.org", "libgen.vg", "libgen.io", "gen.lib.rus.ec", "booksdl.org", "libgen.pm", "libgen.rs", "libgen.is", "libgen.st", "libgen.fun", "libgen.la", "libgen.bz", "libgen.gl", "llhlf.com" });
        return ret;
    }
