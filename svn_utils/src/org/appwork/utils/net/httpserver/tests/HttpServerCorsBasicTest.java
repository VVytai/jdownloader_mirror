...
/**
 * Basic CORS (Cross-Origin Resource Sharing) tests for HTTP server.
 *
 * <p>
 * This test class covers fundamental CORS functionality including:
 * </p>
 * <ul>
 * <li>Default CORS behavior (blocked by default)</li>
 * <li>CORS header validation</li>
 * <li>Wildcard origins</li>
 * <li>Pattern-based credentials and private network rules</li>
 * <li>CORS handler validation</li>
 * </ul>
 *
 * @author AppWork
 */
public class HttpServerCorsBasicTest extends HttpServerTestBase {
    ...
    public void runTest() throws Exception {
        ...
        try {
            ...
            // CORS functionality tests (each test configures CORS itself)
            ...
            // CORS wildcard: allow any origin
    ...
    private void testEmptyOriginHeaderBlocked() throws Exception {
        this.assertOriginBlocked("", org.appwork.utils.net.httpserver.AbstractServerBasics.FORBIDDEN_ORIGIN);
    }
    ...
    /**
     * Test 13: Wildcard CORS should allow any Origin and return the requesting origin
     */
    private void testCorsAllowAllOrigins() throws Exception {
        ...
        final String allowOrigin = context.getConnection().getHeaderField(HTTPConstants.HEADER_RESPONSE_ACCESS_CONTROL_ALLOW_ORIGIN);
        assertEquals(origin, allowOrigin, "Wildcard CORS should return Access-Control-Allow-Origin with the requesting origin");
        LogV3.info("Test 13 passed: Wildcard CORS allowed Origin with Access-Control-Allow-Origin=" + allowOrigin);
    }
    ...
    private void testCredentialsPatternRules() throws Exception {
        ...
        final List<OriginRule> allowedOrigins1 = new java.util.ArrayList<OriginRule>();
        allowedOrigins1.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins1);
    ...
    private void testCredentialsPatternRulesPriority() throws Exception {
        ...
        // Disable validation for this test - we're testing pattern rules functionality, not validation
        corsHandler.setEnableSecurityValidation(false);
        final List<OriginRule> allowedOrigins2 = new java.util.ArrayList<OriginRule>();
        allowedOrigins2.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins2);
    ...
    private void testCredentialsPatternRulesDefaultDeny() throws Exception {
        ...
        // Disable validation for this test - we're testing pattern rules functionality, not validation
        corsHandler.setEnableSecurityValidation(false);
        final List<OriginRule> allowedOrigins3 = new java.util.ArrayList<OriginRule>();
        allowedOrigins3.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins3);
    ...
    private void testPrivateNetworkPatternRules() throws Exception {
        ...
        final CorsHandler corsHandler = new CorsHandler();
        final List<OriginRule> allowedOrigins4 = new java.util.ArrayList<OriginRule>();
        allowedOrigins4.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins4);
        // Test: No rules - should return false (default deny)
    ...
    private void testPrivateNetworkPatternRulesPriority() throws Exception {
        ...
        final CorsHandler corsHandler = new CorsHandler();
        final List<OriginRule> allowedOrigins5 = new java.util.ArrayList<OriginRule>();
        allowedOrigins5.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins5);
        // Add deny-all rule first
        corsHandler.addPrivateNetworkRequestRule(Pattern.compile(".*"), false);
        // Add allow rule for specific origin (higher priority - checked last)
        corsHandler.addPrivateNetworkRequestRule(Pattern.compile("https://example\\.com"), true);
    ...
    private void testPrivateNetworkPatternRulesDefaultDeny() throws Exception {
        ...
        final CorsHandler corsHandler = new CorsHandler();
        final List<OriginRule> allowedOrigins9 = new java.util.ArrayList<OriginRule>();
        allowedOrigins9.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins9);
        // Add rule for specific pattern
        corsHandler.addPrivateNetworkRequestRule(Pattern.compile("https://example\\.com"), true);
        // Test: Matching origin should be allowed
    ...
    private void testCredentialsPatternRulesInHttpResponse() throws Exception {
        ...
        final CorsHandler corsHandler = new CorsHandler();
        final List<OriginRule> allowedOrigins = new java.util.ArrayList<OriginRule>();
        allowedOrigins.add(new OriginRule("https://example.com"));
        allowedOrigins.add(new OriginRule("https://trusted.com"));
    ...
    private void testCorsHandlerValidation() throws Exception {
        ...
        final List<OriginRule> allowedOrigins7 = new java.util.ArrayList<OriginRule>();
        allowedOrigins7.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins7);
        try {
            corsHandler.addCredentialsRule((Pattern.compile(".*")), true);
    ...
    private void testCorsHandlerValidationDisabled() throws Exception {
        ...
        final List<OriginRule> allowedOrigins8 = new java.util.ArrayList<OriginRule>();
        allowedOrigins8.add(new OriginRule("*"));
        corsHandler.setAllowedOrigins(allowedOrigins8);
        corsHandler.addCredentialsRule(Pattern.compile(".*"), true);
